...
#select folder
setwd('C:/Users/biolp/OneDrive/Documentos/Projetos/Pneumatica in vivo/results/curvas_species/olea1')
#put the correct file name 
#raw <- read.delim("log.txt", header=T, sep=' ', as.is=T)
raw <- read.csv('olea1.csv', header=T, sep=',', as.is=T)
psy <- read.csv('olea1_id.csv', header=T, sep=',', as.is=T)
